 ...
 */
package com.example.demoMaven.dao.bean;
...
@Table(name = "cart", schema = "public", uniqueConstraints = {
    @UniqueConstraint(name = "cart_pkey", columnNames = {"cart_number"})
}, indexes = {
    @Index(name = "cart_pkey", unique = true, columnList = "cart_number ASC")
})
public class CartU implements Serializable {

    private static final long serialVersionUID = 1353121711;
